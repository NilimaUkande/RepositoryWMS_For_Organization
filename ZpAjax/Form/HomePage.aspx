<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage_res.master" AutoEventWireup="true" CodeFile="HomePage.aspx.cs" Inherits="Form_HomePage" Title="Work Information" %>
                                        ...
                                        <ul class="quick-actions">
                                            <li><%--<a href="#">--%> <%--<i class="icon-dashboard"></i>--%>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                    <ContentTemplate>
                                                        &nbsp;
                                                        <asp:Label runat="server" Width="90%" Font-Underline="False" Height="40px" ForeColor="#000000" ID="Label55"></asp:Label>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"></asp:AsyncPostBackTrigger>
                                                    </Triggers>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:DataGrid ID="datagrid" runat="server" Font-Names="Verdana" CssClass="Grid" AllowPaging="True"
                                                ...
                                                OnPageIndexChanged="datagrid_PageIndexChanged" OnSelectedIndexChanged="datagrid_SelectedIndexChanged" ToolTip="Select Work To View  Stages" PageSize="12">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:ButtonColumn CommandName="Select" DataTextField="workname" HeaderText="कामाचे नाव" HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true"></asp:ButtonColumn>
                                        ...
                                        <ul class="quick-actions">
                                            <li><%--<a href="#">--%> <%--<i class="icon-shopping-bag"></i>--%><asp:Label ID="Label1" ForeColor="#000000" runat="server" Text="कामाचे नाव"></asp:Label>
                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Label ID="Label2" runat="server" Font-Bold="true" Height="40px" ForeColor="#000000" Font-Size="Medium"></asp:Label>
                                            ...
                                            <asp:Panel ID="Panel1" runat="server" Visible="False">
                                                <asp:DataGrid ID="gv_List" runat="server" ToolTip="Select Stage To Fill Information" OnSelectedIndexChanged="gv_List_SelectedIndexChanged" CellPadding="4" AutoGenerateColumns="False">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true">
                                                            <ItemTemplate>

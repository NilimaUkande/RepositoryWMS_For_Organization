<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage_res.master" AutoEventWireup="true" CodeFile="Userlog_report.aspx.cs" Inherits="Form_Userlog_report" Title="Work Information" %>
...
<asp:DataGrid id="datagrid" runat="server"  Font-Names="Verdana" CssClass="Grid"   AllowPaging="True"
     ...
     <Columns>
         <asp:BoundColumn DataField="udate" HeaderText="वेळ" ItemStyle-Width="8%"  HeaderStyle-HorizontalAlign="Center"  HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true"></asp:BoundColumn>
         <asp:BoundColumn DataField="user_object" HeaderText="पेजचे नाव" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true"></asp:BoundColumn>
         <asp:BoundColumn DataField="user_action" HeaderText="कृती" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true"></asp:BoundColumn>
         <asp:BoundColumn DataField="username" HeaderText="युजरनेम" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true"></asp:BoundColumn>

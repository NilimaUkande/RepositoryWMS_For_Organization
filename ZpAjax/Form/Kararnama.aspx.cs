...
public partial class Form_Kararnama : System.Web.UI.Page
{
...

    {
     ...
     // para.Add(HiddenField1.Value.ToString());
        ...
        ds = bl_ob.FillGridWithParameter(para, "Sp_Fill_KararnamaDetails");
        ...
        if (ds.Tables[0].Rows.Count != 0)
        {
            ...
            txtKararnamaKramank.Text = ds.Tables[0].Rows[0][0].ToString();
            txtTharavKramankFinal.Text = ds.Tables[0].Rows[0][1].ToString();
            txtKararnamaManjurDate.Text = ds.Tables[0].Rows[0][2].ToString();
            txtStampPaperRakkam.Text = ds.Tables[0].Rows[0][3].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
     ...
     setzero();
        ...
        //  para.Add(HiddenField1.Value.ToString());//thedkedarID
            para.Add(txtKararnamaKramank.Text);
            para.Add(txtTharavKramankFinal.Text);
            string date = bl_ob.convertDate(txtKararnamaManjurDate.Text);
            para.Add(date);
            para.Add(txtStampPaperRakkam.Text);
            ...
            para.Add("a");
            ds = bl_ob.ExecuteStoredFunctionWithParameters(para, "Sp_KararnamaDetails");
    ...
    {
        List<TextBox> plist = new List<TextBox>();
        plist.Add(txtKararnamaKramank);
        plist.Add(txtTharavKramankFinal);
        plist.Add(txtKararnamaManjurDate);
        plist.Add(txtStampPaperRakkam);
        bl_ob.TextboxNull(plist);
    }
    ...
    {
        Response.Redirect("~/Report/Kararnama_Report.aspx");
    }
    ...
    protected void btn_nxt_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Form/WorkOrder.aspx");
    }
    ...
    //{
    //    txtKararnamaManjurDate.Text = Calendar1.TodaysDate.ToShortDateString();
    //    txtKararnamaManjurDate.Text = Calendar1.SelectedDate.ToShortDateString();
    //}

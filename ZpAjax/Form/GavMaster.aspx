<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage_res.master" AutoEventWireup="true" CodeFile="GavMaster.aspx.cs" Inherits="Form_ChangeVillageMaster" Title="गाव मास्टर" %>
     ...
     <center>   
         <table style="border-right: maroon 2px solid; border-top: maroon 2px solid; border-left: maroon 2px solid;
             ...
             <tr>
                 ...
                 <td colspan="10"><center>
                    <asp:Label ID="Label5" runat="server" CssClass="title"  Height="19px"
                        Text="गाव मास्टर" Width="316px" Font-Names="Verdana"  style="vertical-align: middle"></asp:Label></center></td>
                 <td style="width: 5%">
                 </td>
                 <td colspan="3">
                    <asp:TextBox ID="TextBox1" runat="server" BorderStyle="Solid" BorderWidth="1px" CssClass="txtbox"
                        Height="22px" Visible="False" Width="77px"></asp:TextBox></td>
                 <td style="width: 5%">
                 </td>
             </tr>
             <tr>
                 ...
                 <td colspan="4" style="text-align: left">
                    <asp:Label ID="Label2" runat="server" CssClass="lbl"  Text="तालुका"
                        Width="106px" Font-Names="Verdana" ></asp:Label></td>
                 <td colspan="5" style="text-align: left">
                    <asp:DropDownList ID="ddlTaluka" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlTaluka_SelectedIndexChanged" CssClass="ddl" Width="75%" Font-Names="Verdana" >
                    </asp:DropDownList></td>
                 <td style="width: 5%">
                 </td>
                 <td style="width: 5%">
             ...
             <tr>
                 ...
                 <td colspan="4" style="text-align: left">
                    <asp:Label ID="Label1" runat="server" CssClass="lbl"  Height="12px"
                        Text="गावाचे नाव " Width="123px" Font-Names="Verdana" ></asp:Label></td>
                 <td colspan="5" style="text-align: left">
                    <asp:TextBox ID="txtvillage" runat="server" BorderStyle="Solid" BorderWidth="1px" Height="22px" Width="90%" Font-Names="Verdana" ></asp:TextBox></td>
                 <td style="width: 5%">
                 </td>
                 <td style="width: 5%">
                 </td>
             ...
             <tr>
                 ...
                 <td colspan="4" style="text-align: left">
                    <asp:Label ID="Label4" runat="server"  Font-Names="Verdana"
                         Text="लोकसंख्या" Width="60px"></asp:Label></td>
                 <td colspan="5" style="text-align: left">
                    <asp:TextBox ID="txtLoksankhya" runat="server" Width="90%" ></asp:TextBox></td>
                 <td style="width: 5%">
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtLoksankhya"
                         Display="Dynamic" ErrorMessage="X" ValidationExpression="[0-9]*" ValidationGroup="a"></asp:RegularExpressionValidator></td>
                 <td style="width: 5%">
                 </td>
                 <td style="width: 5%">
                 </td>
             ...
             <tr>
                 ...
                 <td colspan="7" style="text-align: left">
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal"
                        Width="98%"  Font-Names="Verdana" >
                        <asp:ListItem Value="आदिवासी">आदिवासी</asp:ListItem>
                        <asp:ListItem Value="बिगर आदिवासी" Selected="True">बिगर आदिवासी</asp:ListItem>
             ...
             <tr>
                 ...
                 <td colspan="2">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="Reset" /></td>
                 <td style="width: 5%">
                 </td>
                 <td style="width: 5%">
                 </td>
             ...
             <tr>
                 ...
                 <center> 
                     <asp:UpdatePanel id="UpdatePanel1" runat="server">
                         <contenttemplate>
<asp:Label id="lblMsg" runat="server" Width="90%" ForeColor="Red" Font-Size="XX-Small" EnableViewState="False"></asp:Label> <asp:UpdateProgress id="UpdateProgress1" runat="server"><ProgressTemplate>
             ...
             <tr>
                 <td colspan="20"><center>
                     <asp:UpdatePanel id="UpdatePanel2" runat="server">
                         <contenttemplate>
                    <asp:DataGrid ID="datagrid" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" Width="90%" OnSelectedIndexChanged="datagrid_SelectedIndexChanged" Font-Names="Verdana" Font-Size="10pt" AllowPaging="True" OnPageIndexChanged="datagrid_PageIndexChanged" > 
                        ...
                        <Columns>
                            ...
                            <asp:ButtonColumn CommandName="Select" Text="Edit" HeaderText="Select"></asp:ButtonColumn>
...
<asp:PostBackTrigger ControlID="datagrid"></asp:PostBackTrigger>
             ...
             <tr>
                 ...
                 <td colspan="5" style="text-align: right">
                    <asp:Label ID="Label3" runat="server" EnableViewState="False" ForeColor="Red" Width="85%" Font-Size="X-Small"></asp:Label></td>
                 <td colspan="2">

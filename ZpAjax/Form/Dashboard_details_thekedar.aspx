<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage_res.master" AutoEventWireup="true" Title="Dashboard Details" CodeFile="Dashboard_details_thekedar.aspx.cs" Inherits="Form_Dashboard_details_thekedar" %>
               ...
               <td colspan="20"><center>
                ...
                <asp:datagrid ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="AndajptrakiyRakkam" HeaderText="AndajptrakiyRakkam" HeaderStyle-ForeColor="White" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>

...
public partial class Form_Dashboard_details_talukawise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
          string flag=  Request.QueryString["q"];
            ...
            //        (HiddenField)Page.PreviousPage.FindControl("hdnSomeField");
            //    if (SourceTextBox != null)
            //    {
            //        string flag = SourceTextBox.Value;
            //    }
            //}
    ...
    protected void fillGrid()
    {
        ...
        plist.Add(Request.QueryString["p"]);
        plist.Add(Request.QueryString["q"]);
        ds = bl_obj.ExecuteStoredFunctionWithParameters(plist, "alert_window_for_ceo_talukawise_details");      
